...
class SignalDetector {
    ...
    determineDirection(marketId, polyState, kalshiState) {
        ...
        if (weightedVelocity > 0.005) return 'YES';  // Price going up → buy YES
        if (weightedVelocity < -0.005) return 'NO';   // Price going down → buy NO
